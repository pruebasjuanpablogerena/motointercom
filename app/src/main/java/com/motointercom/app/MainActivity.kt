...
class MainActivity : AppCompatActivity(), IntercomService.Escucha {
    ...
    companion object {
        private const val URL_RELEASES = "https://github.com/pruebasjuanpablogerena/motointercom/releases/latest"
    }
    ...
    private var pendienteDetenerBluetooth: Runnable? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnBuscarActualizaciones).setOnClickListener {
            try {
                val intent = Intent(Intent.ACTION_VIEW, android.net.Uri.parse(URL_RELEASES))
        ...
        btnHablar.setOnTouchListener { boton, evento ->
            when (evento.action) {
                ...
                android.view.MotionEvent.ACTION_UP, android.view.MotionEvent.ACTION_CANCEL -> {
                    ...
                    pendienteDetenerBluetooth = corte
